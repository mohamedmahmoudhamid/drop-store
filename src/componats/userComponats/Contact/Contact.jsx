...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://special-books-9908bd4b11.strapiapp.com/api/contacts", {
      method: "POST",
      headers: {
      ...
      .catch(() => {
        setSeverity("error");
        setAlertMsg("حدث خطأ أثناء الإرسال ❌");
        setOpen(true);
      })
      .finally(() => {
        setLoading(false);
        ...
        <CardContent sx={{ p: 4 }}>
          ...
          <form onSubmit={handleSubmit}>
            <TextField
              ...
              InputLabelProps={{ style: { color: "#2072AF" } }}
              InputProps={{
                style: { color: "#2072AF", borderColor: "#F0F8FF" },
              }}
            />
            <TextField
              label="البريد الإلكتروني"
